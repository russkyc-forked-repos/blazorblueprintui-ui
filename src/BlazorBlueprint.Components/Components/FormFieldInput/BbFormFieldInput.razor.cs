...
/// <summary>
/// An opinionated form field that composes <see cref="BbInputField{TValue}"/> with
/// <see cref="BbField"/>, <see cref="BbFieldLabel"/>, <see cref="BbFieldDescription"/>,
/// and <see cref="BbFieldError"/> for a complete, ready-to-use form field experience.
/// </summary>
/// <remarks>
/// <para>
/// FormFieldInput provides a higher-level abstraction over the primitive <see cref="BbInputField{TValue}"/>.
...
/// </para>
/// <para>
/// For full control over layout and error display, use <see cref="BbInputField{TValue}"/> directly
...
/// - All <see cref="BbInputField{TValue}"/> parameters passed through
...
/// </code>
/// </example>
public partial class BbFormFieldInput<TValue> : FormFieldBase
{
    private BbInputField<TValue>? _inputRef;
