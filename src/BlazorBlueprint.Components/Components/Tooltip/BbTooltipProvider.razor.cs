...
/// <see cref="TooltipProviderContext"/> to all descendant <see cref="BbTooltip"/> components.
/// </para>
/// <para>
...
/// individual <see cref="BbTooltip"/> components can function without a provider using
...
/// </code>
/// </example>
public partial class BbTooltipProvider : ComponentBase
{
    ...
    /// <remarks>
    /// <para>
    /// This delay applies to all child <see cref="BbTooltip"/> components. When a user
    ...
    /// </value>
    /// <remarks>
    /// All child <see cref="BbTooltip"/> components will receive the tooltip configuration
