...
/// </code>
/// </example>
public partial class BbDataTable<TData> : ComponentBase where TData : class
{
    /// <summary>
    ...
    public class ColumnData
    {
        ...
        public Func<TData, object?>? Property { get; set; }
    ...
    /// </summary>
    internal void RegisterColumn<TValue>(BbDataTableColumn<TData, TValue> column)
    {
        ...
        var columnData = new ColumnData
        {
            ...
            Property = column.Property != null ? item => column.Property(item) : null,
