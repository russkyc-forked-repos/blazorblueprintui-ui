...
/// <list type="bullet">
/// <item><see cref="BbCollapsible"/> - Styled container that manages state</item>
/// <item><see cref="BbCollapsibleTrigger"/> - Styled button that toggles the open/closed state</item>
/// <item><see cref="BbCollapsibleContent"/> - Styled content area that expands/collapses</item>
/// </list>
/// </para>
/// <para>
...
public partial class BbCollapsible : ComponentBase
{
    ...
    /// Typically contains:
    /// <list type="bullet">
    /// <item><see cref="BbCollapsibleTrigger"/> - The button/trigger element</item>
    /// <item><see cref="BbCollapsibleContent"/> - The expandable content area</item>
    /// </list>
    /// </remarks>
    [Parameter]
